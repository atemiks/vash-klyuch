$(function () {
    ...
    $(document).on('click', '.product-specification-toggle', function(e) {
        let target = $(e.currentTarget),
            container = target.closest('.product-specifications-block'),
            specificationList = container.find('.product-specifications-list'),
            specificationSecondaryElements =  specificationList.find('.product-specification-secondary-item');

        if (target.data('expended') == false) {
            specificationSecondaryElements.slideDown();
        } else {
            specificationSecondaryElements.slideUp();
        }

        container.find('.product-specification-toggle').removeClass('d-none');
